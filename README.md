...
The public validators do not require third-party runtime dependencies. Install the optional dependencies when running local Qwen-based methods or visual Grounders:
...
methods/text/               StateCommit text method and baselines
methods/visual/             Visual Runtime, Fast Path, and renderer interfaces
scripts/                    Text runner and IRMem utility
